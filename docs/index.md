...
- `cardano_node_master/`: A mixed-version testnet with 5 block producers (cardano-node 10.5.3, 10.6.2, 10.7.1, 11.0.1, plus Dingo 0.68.0), 4 relay nodes (cardano-node 10.6.2, 10.7.1, 11.0.1, plus Dingo 0.68.0), tracer observability, Asteria Plutus workload pressure, and tx-generator ADA-transfer pressure. See [cardano-node-master](testnets/cardano-node-master.md) for details.
